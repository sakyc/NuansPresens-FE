...
export function RequestTab({ onViewAllHistory }: RequestTabProps) {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'rejected':
        return (
          <Badge className="bg-destructive/20 text-destructive">Ditolak</Badge>
        );
      default:
        ...
        <CardContent className="space-y-5 p-5">
          ...
          <div className="space-y-2">
            ...
            {imagePreview ? (
              ...
              <div className="flex flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-border bg-input/50 p-6">
                <div
                  className={`rounded-full p-3 ${dataPengajuan.bg_color_mudar}`}
                >
                ...
                <UploadButton
                  ...
                  onClientUploadComplete={(res: any) => {
                    ...
                    setImageUrl(url);
                    setImagePreview(url); // supaya preview muncul
          ...
          <div className="w-full max-w-sm rounded-3xl bg-card p-6 shadow-2xl">
            {submissionStatus === 'loading' && (
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  <h3 className="text-lg font-semibold">Mengirim Pengajuan</h3>
